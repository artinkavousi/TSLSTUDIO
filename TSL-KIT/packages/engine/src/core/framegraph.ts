import { Camera, Clock, RenderTarget, Scene, Vector2 } from 'three'
import type { WebGPURenderer } from 'three/webgpu'

export type FramegraphResourceMap = Map<string, unknown>

export interface FramegraphExecutionContext {
...
export interface FramegraphSetupContext {
  renderer: WebGPURenderer
  resources: FramegraphResourceMap
  userData: Record<string, unknown>
}
...
export interface FramegraphProfile {
  frame: number
  delta: number
  timestamp: number
  passes: Array<{
