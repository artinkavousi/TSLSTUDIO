import type { ColorRepresentation, ToneMapping, ColorSpace } from 'three'
...
export type RendererInitOptions = Partial<WebGPURendererParameters> & {
...
function isHTMLElement(target: ResizeTarget | undefined): target is HTMLElement {
  return typeof window !== 'undefined' && target instanceof HTMLElement
}

function resolveResizeTarget(
  renderer: WebGPURenderer,
  option: AutoResizeOption | undefined,
