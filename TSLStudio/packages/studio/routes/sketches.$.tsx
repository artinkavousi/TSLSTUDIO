...
import WebGPUScene from '@studio/components/canvas/webgpu_scene'
import { PostProcessing, makePostChain } from '@tsl/post'
import { ParticlesPoints } from '@studio/components/compute/particles_points'
import { WebGPUSketch } from '@studio/components/canvas/webgpu_sketch'
      ...
      <Suspense fallback={null}>
        {colorNode ? (
          ...
          >
            ...
            <ParticlesPoints count={256*256} />
            <PostProcessing
              effect={makePostChain([
                ['tonemap', { curve: 'ACES' }],
                ['bloom', { threshold: 1.0, strength: 0.55, radius: 1.5 }],
