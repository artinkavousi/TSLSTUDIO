...
import { simplexNoise3d } from './simplex_noise_3d.js'
 ...
 */
export const fbm = Fn(([p, octaves = 4.0, frequency = 1.0, amplitude = 1.0, lacunarity = 2.0, gain = 0.5]: any) => {
 ...
 */
export const ridgedFbm = Fn(([p, octaves = 4.0, frequency = 1.0, amplitude = 1.0, lacunarity = 2.0, gain = 0.5]: any) => {
  const value = float(0.0).toVar()
  const currentAmplitude = float(amplitude).toVar()
  const currentFrequency = float(frequency).toVar()
  const maxValue = float(0.0).toVar()
...
export const domainWarpedFbm = Fn(
  ([p, octaves = 4.0, frequency = 1.0, amplitude = 1.0, lacunarity = 2.0, gain = 0.5, warpStrength = 0.1]: any) => {
